...
public final class DebugForScaff extends Hack {
	...
	public DebugForScaff() {

		super("Yaw/Pitch", "Shows Yaw and Pitch and Facing.");
	...
	public void onRenderGUI(RenderGameOverlayEvent.Post event) {
		...
		WMinecraft.getFontRenderer().drawStringWithShadow(
				"Yaw:" + " " + yaw() + " " + " | " + "Pitch:" + " " + pitch(), ValueX.getValueF(), ValueY.getValueF(), textColor);
		GL11.glPopMatrix();
	}
	public static int yaw() {
		return Math.round(mc.player.rotationYaw);
	}

	public static int pitch() {
		return Math.round(mc.player.rotationPitch);
	}
}