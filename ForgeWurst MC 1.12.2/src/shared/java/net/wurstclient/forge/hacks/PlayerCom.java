...
public final class PlayerCom extends Hack {
	public PlayerCom() {
		super("InfoExploit", "Shows other players BedCoords, and other info about them.");
	...
	public void onUpdate(WUpdateEvent event) {
		for (Entity e : mc.world.loadedEntityList) {
			if (e instanceof EntityPlayer) {
				...
				BlockPos bed = ((EntityPlayer) e).getBedLocation();
				String name = e.getName();
				long coordx = Math.round(e.lastTickPosX);
				long coordy = Math.round(e.lastTickPosY);
				long coordz = Math.round(e.lastTickPosZ);

				if (!(name == mc.player.getName())) {
					ChatUtils.message(name + " " + "Was found, His BedLocation is:" + " " + bed + " " + " | " + " " + "His Coords are:" + " " + " " + coordx + " " + coordy + " " + coordz + " " + " | ");
				}
			}
		}
	}
